...
class TransformerBaseClass(nn.Module):
	...
	def __init__(self, opts, number_layers=6, attention_heads=8, dropout=0.1, dummy_inputs=False):
		...
		target_embedding_layer = EmbeddingLayer(self.opts.nz, d_model)
